      ...
      <div className="auth-form-panel">
        ...
        >
          ...
          <div className="relative w-full flex justify-center">
            <button
              type="button"
              className="w-full flex items-center justify-center gap-3 py-2.5 px-4 rounded-xl bg-zinc-900 hover:bg-zinc-800 border border-zinc-700/60 text-zinc-200 font-medium text-sm transition-colors shadow-sm"
            >
            ...
            <div id="google-signin-btn" className="absolute inset-0 opacity-0 cursor-pointer overflow-hidden z-10" />
          </div>
